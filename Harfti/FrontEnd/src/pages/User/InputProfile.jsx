   ...
   const [imag , setImag] = useState(false)
    ...
    return(
        <div className="w-full flex justify-center flex-col items-center gap-y-8">
            {user && <img  title="Click To Update" onClick={()=>setImag(true)} src={`http://localhost:3001/uploads/${Items ? Items:user.image }`} className="rounded-[50%] h-30 flex justify-center " />}
